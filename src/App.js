...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    if(response.status == 201){
      ...
      repositoriesUpdated.splice(indexRepositoryOutdated, 1, repositoryUpdated); //Updating the repository (removing repository outdated and adding repository updated)
